...
class CustomDataset(Dataset):
    ...
    def __getitem__(self, index):
        ...
        try:
            # ===================== target audio =====================
            print(f"[TARGET] {index}: {audio_path}")
            ...
            # ===================== control audio =====================
            print(f"[COND]   {index}: {cond_audio_path}")
            ...
            cond_mel_spec = self.mel_spectrogram(cond_audio).squeeze(0)
            ...
            print("\n" + "=" * 80)
            print("❌ BAD AUDIO FOUND")
            print(f"index: {index}")
            print(f"audio_path: {audio_path}")
            print(f"cond_audio_path: {cond_audio_path}")
...
#         else:
#             print("loading target wav:", audio_path)
#             audio, source_sample_rate = torchaudio.load(audio_path)
...
#             print("loading cond wav:", cond_audio_path)
#             cond_audio, cond_sr = torchaudio.load(cond_audio_path)
#             if cond_audio.shape[0] > 1:
#                 cond_audio = torch.mean(cond_audio, dim=0, keepdim=True)
#             if cond_sr != self.target_sample_rate:
